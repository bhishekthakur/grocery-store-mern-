      ...
      <div className="flex items-center h-full justify-between">
        ...
        <div className="flex items-center gap-4 md:gap-7 ">
          <nav className=" gap-4 md:gap-7 text-base md:text-lg hidden md:flex">
            <Link to={""}>Home</Link>
            <Link to={"menu/6511b35483baa5985b2e4848"}>Menu</Link>
          ...
          <div className=" text-slate-600 " onClick={handleShowMenu}>
            ...
            {showMenu && (
              <div className="absolute right-2 bg-white py-2  shadow drop-shadow-md flex flex-col min-w-[120px] text-center">
                ...
                {
                  userData.image ? <p className="cursor-pointer text-white px-2 bg-red-500" onClick={handleLogout}>Logout ({userData.firstName})</p> : (<Link 
                ...
                <nav className=" text-base md:text-lg flex flex-col md:hidden">
                  ...
                  <Link to={"menu/6511b35483baa5985b2e4848"} className="px-2 py-1">Menu</Link>
