    ...
    <div className="p-2 md:p-4">
      <div className="md:flex gap-4 py-2">
        ...
        <div className="md:w-1/2">
          ...
          <p className="p-3 text-base "> Lorem is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </p>
      ...
      <div className="">
            ...
            <div className="flex gap-5 overflow-scroll scrollbar-none scroll-smooth transition-all" ref={slideProductRef}>
              {
               homeproductCartListVegetables[0] ?  homeproductCartListVegetables.map(el =>{return(
                  <CardFeature 
