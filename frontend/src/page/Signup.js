      ...
      <div className="w-full max-w-sm bg-white m-auto flex  flex-col p-4">
        ...
        <label htmlFor="profileImage">
          <div className="absolute bottom-0 h-1/3 bg-slate-500 bg-opacity-50 w-full text-center">
            <p className="text-sm p-1 text-white cursor-pointer">Uoload</p>
        ...
        <form className="w-full py-3 flex flex-col" onSubmit={handleSubmit}>
          ...
          <input
            ...
            id="firstName"
            name="firstName"
            className="mt-1 mb-2 w-full bg-slate-200 px-2 py-1 rounded focus-within:outline-blue-300 " value={data.firstName}
          ...
          <input
            ...
            id="lastName"
            name="lastName"
            className="mt-1 mb-2 w-full bg-slate-200 px-2 py-1 rounded focus-within:outline-blue-300"  value={data.lastName}
            onChange={handleOnChange}
          />
          ...
          <input
            ...
            id="email"
            name="email"
            className="mt-1 mb-2 w-full bg-slate-200 px-2 py-1 rounded focus-within:outline-blue-300"  value={data.email}
            onChange={handleOnChange}
          />

          <label htmlFor="password">Password</label>
          <div className="mt-1 mb-2 flex px-2 py-1 focus-within:outline focus-within:outline-blue-300 bg-slate-200 rounded">
            <input
              type={showPassword ? "text" : "password"}
              id="password"
              name="password"
              className=" w-full bg-slate-200   outline  border-none outline-none " value={data.password}
              onChange={handleOnChange}
            />
            <span
